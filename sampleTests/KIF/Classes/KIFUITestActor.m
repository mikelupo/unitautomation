...
{
	[self pullToRefreshViewWithAccessibilityLabel:label value:nil pullDownDuration:KIFPullToRefreshInAboutThreeSeconds traits:UIAccessibilityTraitNone];
}
...
{
	[self pullToRefreshViewWithAccessibilityLabel:label value:value pullDownDuration: KIFPullToRefreshInAboutThreeSeconds traits:UIAccessibilityTraitNone];
}
